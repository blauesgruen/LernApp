...
// Warteschlange für Funktionen, die nach dem Laden der Speichermodule ausgeführt werden sollen
...
function runWhenStorageReady(fn) {
    if (window.restoreDirectoryHandle) {
        ...
        console.log('Funktion zur Storage-Ready-Warteschlange hinzugefügt');
    }
}

// Event-Listener für das Laden der Speichermodule
window.addEventListener('storageModulesLoaded', () => {
    console.log('Speichermodule geladen, verarbeite Warteschlange mit', window.storageReadyQueue.length, 'Funktionen');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Statt direkter Ausführung zur Storage-Ready-Warteschlange hinzufügen
